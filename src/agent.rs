...
pub struct Agent {
    ...
    /// the percentage of the commodity production that the agent is responsible for.
...
pub struct AgentObjective {
    ...
    /// For “weighted_sum” objective, the set of weights to apply to each objective.
